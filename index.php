...
<!-- Global site tag (gtag.js) - Google Analytics -->
  ...
  <script >alert("Olá Sou o Marcos Gabriel Seja Bem Vindo a meu Portfólio ele ainda está em construção mas pode ver as partes que já estão prontas para acessar use o      LOGIN: marcos      SENHA: 123.  ")</script>
  </script>
  </body>
</html>